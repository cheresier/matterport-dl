...
GRAPH_DATA_REQ = {
    ...
    # GetLayers is required by the CWF engine (readLayersForView) to load the view's layer configuration.
    # Variables use viewId (same value as modelId for standard models).
    # APQ hash computed from graph_posts/GetLayers.json query document.
    "GetLayers": "?operationName=GetLayers&variables=%7B%22viewId%22%3A%22[MATTERPORT_MODEL_ID]%22%7D&extensions=%7B%22persistedQuery%22%3A%7B%22version%22%3A1%2C%22sha256Hash%22%3A%22a7e866f0aca615ea0c22cb7ab2881ead85955eda5cad9bf29ddf3db783621ff6%22%7D%7D",
}
